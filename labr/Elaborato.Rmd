...
# Importazione e lavoro di machete
...
## Descrizione e lavori di bisturi
...
La media dei messaggi nel periodo è stata `r mean(HP$n)`, mentre la media nei giorni specifici di trasmissione di Harry Potter è stata `r mean(HPDate$n)`, ampiamente all'interno della deviazione standard del periodo in considerazione, `r sd(HP$n)`.
